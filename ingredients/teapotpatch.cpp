...
void TeapotPatch::buildPatchReflect(int patchNum, std::vector<GLfloat>& p, int& index, bool reflectX, bool reflectY)
{
    glm::vec3 patch[4][4];
...
void TeapotPatch::buildPatch(glm::vec3 patch[][4], std::vector<GLfloat>& pts, int& index, glm::mat3 reflect)
{
    for (int i = 0; i < 4; i++)
    {
        for (int j = 0; j < 4; j++)
