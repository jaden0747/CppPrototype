...
private:
    ...
    void buildPatchReflect(int patchNum, std::vector<GLfloat>& p, int& index, bool reflectX, bool reflectY);
    void buildPatch(glm::vec3 patch[][4], std::vector<GLfloat>& pts, int& index, glm::mat3 reflect);
